...
func GetDnaScene() shapes.Group {
    return shapes.Group{
        []shapes.Shape{
            ...
            shapes.Group{generateDnaString(vec3.Vec3{0,0,-1}, vec3.Vec3{5,0,0},40)},
            shapes.Plane{vec3.Vec3{0,-7,0}, vec3.Vec3{0,1,0}, shapes.Material_Metal{vec3.Vec3{0.1,0.1,0.4}, 0.05}},
            shapes.Sphere{vec3.Vec3{-15,0,-60}, 10, shapes.Material_Metal{vec3.Vec3{1,1,1}, 0}},
