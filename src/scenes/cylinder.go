    ...
    return shapes.Group {
        []shapes.Shape{
            shapes.NewCylinder(
                ...
                1,
                2.5,
                shapes.Material_Metal{vec3.Vec3{1,0.8,0.8}, 0},
                // shapes.Material_Transparent{vec3.White, 1.5},
            ),
            shapes.NewCylinder(
                vec3.Vec3{-1,-1.3,-13},
            ...
            shapes.Sphere{
                vec3.Vec3{0,-1.3,-1.5},
                0.5,
                shapes.Material_Diffuse{vec3.Vec3{0,1,0}},
            },
            shapes.Sphere{
                vec3.Vec3{0,-1.3,-6},
                0.5,
                shapes.Material_Diffuse{vec3.Vec3{0,0,1}},
            },
            shapes.Sphere{
                vec3.Vec3{0,0.6,-0.5},
                0.8,
                shapes.Material_Transparent{vec3.Vec3{1,1,1}, 1.5},
            },
            shapes.Plane{ // bottom
